...
public interface Constants {
    ...
    enum PhotosListType {
        SOCIAL_LIST, CURRENT_PHOTOGRAPHER_PHOTOS_LIST, CURRENT_PHOTOGRAPHER_SAVED_LIST, USER_PROFILE_PHOTOS_LIST, ALBUM_PREVIEW_LIST, CAMPAIGN_IMAGES_LIST,STUDIO_IMAGE_LIST
    }
