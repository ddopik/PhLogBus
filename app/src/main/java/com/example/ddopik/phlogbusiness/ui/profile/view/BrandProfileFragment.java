 ...
 */
public class BrandProfileFragment extends BaseFragment implements BrandProfileFragmentView {
    ...
    @Override
    public void viewBrandProfileData(Brand brand) {
        ...
        if (brand.industry != null)
            brandIndustry.setText(brand.industry.nameEn);




        GlideApp.with(this)
                .load(brand.thumbnail)
